...
[![GitHub stars](https://img.shields.io/github/stars/Alpha-Park/genpark-short-time-fourier-transform-stft-spectrogram-skill?style=social)](https://github.com/Alpha-Park/genpark-short-time-fourier-transform-stft-spectrogram-skill/stargazers)
...
```bash
git clone https://github.com/Alpha-Park/genpark-short-time-fourier-transform-stft-spectrogram-skill.git
